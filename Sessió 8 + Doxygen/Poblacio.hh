...
public:
    ...
    */
    ...
    /** @brief Inclosora de la població.
        ...
        \post S'afegeix l'individu a la població.
    */
    ...
    */
    ...
    /** @brief Completadora d'arbres.
        ...
        \post S'imprimeix pel canal de sortida l'arbre complet amb arrel establerta a l'individu, marcant les individus que faltaven a l'arbre d'entrada amb <b>*nom_individu*</b>. Si l'arbre d'entrada no fos parcial (hi haguessin incoherències o es tractés d'un arbre complet) es mostrarà <b>"no es arbol parcial"</b> pel canal de sortida.
    */
