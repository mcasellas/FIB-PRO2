...
public:
    ...
    */
    ...
    /** @brief Creadora d'un nou individu mitjançant la reproducció.
     ...
     \pre El paràmetre implicit està inicialitzat, l'explícit conté els individus que formaran la genètica del possible fill, els seus noms i el nom del possible fill. Es preparen pel canal d'entrada N parells de cromosomes que s'usaràn per el creuament i el seu punt de tall.
     \post Si la reproducció és possible, es definirà l'individu del paràmetre implicit. Si algun dels dos pares no existeix o el nom del fill ja ha estat usat es mostrarà el missatge <b>"error"</b>. En cas de no ser possible la reproducció es mostrarà el missatge <b>"no es possible reproduccion"</b>.
     */
    ...
    /** @brief Consultora del sexe de l'individu.
     ...
     \post Es retorna el sexe de l'individu: X per noia, Y per noi (només pot ser un d'aquests dos).
    */
